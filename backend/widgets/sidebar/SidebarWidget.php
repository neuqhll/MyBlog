...
{    
    ...
    public function init()
    {
        $this->items = [
            ...
            ['label' =>'<i class="fa fa-dashboard"></i><span>Gii</span>','url'=>'http://www.backend.com/gii'],
            ...
            ['label' =>'<a href=""><i class="fa fa-user"></i><span>会员管理</span></a>','options'=>['class'=>'nav-parent'],'items'=>[
                    ['label'=>'会员信息','url'=>['user/index']],'items'=>[
                        ['label'=>'更新','url'=>['user/update'],'visible'=>false],
                        ['label'=>'详情','url'=>['user/view'],'visible'=>false],
                    ]
                ],
            ],
            ['label' =>'<a href=""><i class="fa fa-user"></i><span>前台管理</span></a>','options'=>['class'=>'nav-parent'],'items'=>[
                ['label'=>'前台主页','url'=>'http://www.test.com'],
                ['label'=>'文章预览','url'=>'http://www.test.com/post/index'],
                ['label'=>'新建文章','url'=>'http://www.test.com/post/create'],
            ],
            ],
